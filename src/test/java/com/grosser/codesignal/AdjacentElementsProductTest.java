...
public class AdjacentElementsProductTest {
    ...
    public void testAdjacentElementsProduct001() {
        ...
        assertEquals(21, adjacentElementsProduct.adjacentElementsProduct(input));
    }

    @Test
    public void testAdjacentElementsProduct002() {
        int[] input = {-1, -2};
        assertEquals(2, adjacentElementsProduct.adjacentElementsProduct(input));
    }

    @Test
    public void testAdjacentElementsProduct003() {
        int[] input = {1, 2, 3, 0};
        assertEquals(6, adjacentElementsProduct.adjacentElementsProduct(input));
    }

    @Test
    public void testAdjacentElementsProduct004() {
        int[] input = {9, 5, 10, 2, 24, -1, -48};
        assertEquals(50, adjacentElementsProduct.adjacentElementsProduct(input));
    }

    @Test
    public void testAdjacentElementsProduct005() {
        int[] input = {5, 6, -4, 2, 3, 2, -23};
        assertEquals(30, adjacentElementsProduct.adjacentElementsProduct(input));
    }
    ...
    public void testAdjacentElementsProduct007() {
        ...
        assertEquals(-12, adjacentElementsProduct.adjacentElementsProduct(input));
    }

    @Test
    public void testAdjacentElementsProduct008() {
        int[] input = {1, 0, 1, 0, 1000};
        assertEquals(0, adjacentElementsProduct.adjacentElementsProduct(input));
    }
